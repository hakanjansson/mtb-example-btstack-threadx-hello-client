...
#error "Unexpected MPN; expected DEVICE:=CYW55513IUBG. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
